        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              <tr>
                <td>
                  <img src="<?php echo base_url('assets/images/faces/face1.jpg') ?>" class="me-2" alt="image"> David Grey
                </td>
              ...
              <tr>
                <td>
                  <img src="<?php echo base_url('assets/images/faces/face2.jpg') ?>" class="me-2" alt="image"> Stella Johnson
                </td>
              ...
              <tr>
                <td>
                  <img src="<?php echo base_url('assets/images/faces/face3.jpg') ?>" class="me-2" alt="image"> Marina Michel
                </td>
              ...
              <tr>
                <td>
                  <img src="<?php echo base_url('assets/images/faces/face4.jpg') ?>" class="me-2" alt="image"> John Doe
                </td>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="d-flex mt-5 align-items-top">
          <img src="<?php echo base_url('assets/images/faces/face3.jpg') ?>" class="img-sm rounded-circle me-3" alt="image">
...
<script>
var url = "<?php echo base_url('assets/js/jquery.cookie.js') ?>";
$.getScript(url);
</script>
...
<script>
var url = "<?php echo base_url('assets/js/dashboard.js') ?>";
$.getScript(url);
</script>
<script>
var url = "<?php echo base_url('assets/js/todolist.js') ?>";
$.getScript(url);
</script>
