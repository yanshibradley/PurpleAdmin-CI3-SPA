<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
    <a class="navbar-brand brand-logo link-active" href="<?php echo base_url() ?>"><img src="<?php echo base_url('assets/images/logo.svg') ?>" alt="logo" /></a>
    <a class="navbar-brand brand-logo-mini link-active" href="<?php echo base_url() ?>"><img src="<?php echo base_url('assets/images/logo-mini.svg') ?>" alt="logo" /></a>
  </div>
